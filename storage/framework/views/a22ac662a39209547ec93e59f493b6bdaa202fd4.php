...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo e(asset('assets')); ?>/index2.html" class="logo">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
     ...
     <ul class="sidebar-menu">
        ...
        <li><a href="<?php echo e(asset('/')); ?>"><i class="fa fa-book"></i> <span>Kelas</span></a></li>
        <li><a href="<?php echo e(asset('siswa')); ?>"><i class="fa fa-user"></i> <span>Siswa</span></a></li>
    </ul>
  </section>
  <!--/.sidebar -->
  </aside>
